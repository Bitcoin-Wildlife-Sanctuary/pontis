...
export class Bridge extends SmartContract {
    ...
    public finalizeL1Deposit(
        ...
        assert(MerklePath.calcMerkleRoot(MerklePath.NULL_NODE, batchProof) == prevTx.batchesRoot)
        ...
        const stateHash = Bridge.getStateHash(
            batchesRootNew, prevTx.depositAggregatorSPK
        )
    ...
    public finalizeL2Deposit(
        ...
        assert(MerklePath.calcMerkleRoot(batchHash, batchProof) == prevTx.batchesRoot)
    ...
    public createWithdrawal(
        ...
        const bridgeStateHash = Bridge.getStateHash(
            prevTx.batchesRoot, prevTx.depositAggregatorSPK
        )
    ...
    static getStateHash(
        ...
        return hash256(
            batchesRoot + depositAggregatorSPK
        )
    }
